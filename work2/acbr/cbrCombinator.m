...
function [newStats, newSTDData, newCategories, newGoodness, newClass, Retained, numOblived] = cbrCombinator(Stats,STDData,Categories, Goodness, InitGoodness, Instance, InstanceClass, K, ReuseStrategy, Weighted, Weights, Features, Review, Retention,RetentionStrategy,RetentionThreshold, alpha)
    ...
    if Retention
        [newSTDData, newCategories,newGoodness,Retained, numOblived]  = acbrRetentionPhase(newSTDData, knn',d', newCategories,Instance, InstanceClass, newClass, newGoodness, InitGoodness, RetentionStrategy,RetentionThreshold);
    end
