...
function [STDData, Categories,Goodness,Retained, numOblived] = acbrRetentionPhase(STDData, KNN,D, Categories, Instance, InstanceClass, NewClass, Goodness, InitGoodness,  RetentionStrategy, Threshold)
    Retained = false;
    numOblived = 0;
    ...
    if ((size(RetentionStrategy,2)>2) && (isequal(RetentionStrategy(3:4),'-O')))
        ...
        numOblived = size(oblivedIndex,1);
